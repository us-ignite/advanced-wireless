...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='US/Eastern', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.timezone'
        db.delete_column(u'events_event', 'timezone')
