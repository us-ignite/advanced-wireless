...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HubActionClusterMembership'
        db.create_table(u'hubs_hubactionclustermembership', (
        ...
        db.send_create_signal(u'hubs', ['HubActionClusterMembership'])


    def backwards(self, orm):
        # Deleting model 'HubActionClusterMembership'
        db.delete_table(u'hubs_hubactionclustermembership')
