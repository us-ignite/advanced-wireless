...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field hubs on 'Testbed'
        m2m_table_name = db.shorten_name(u'testbeds_testbed_hubs')
        ...
        db.create_unique(m2m_table_name, ['testbed_id', 'hub_id'])


    def backwards(self, orm):
        # Removing M2M table for field hubs on 'Testbed'
        db.delete_table(db.shorten_name(u'testbeds_testbed_hubs'))
