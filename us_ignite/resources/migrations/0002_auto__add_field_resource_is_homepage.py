...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.is_homepage'
        db.add_column(u'resources_resource', 'is_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.is_homepage'
        db.delete_column(u'resources_resource', 'is_homepage')
