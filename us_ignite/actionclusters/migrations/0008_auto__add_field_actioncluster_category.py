...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionCluster.category'
        db.add_column(u'actionclusters_actioncluster', 'category',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionCluster.category'
        db.delete_column(u'actionclusters_actioncluster', 'category')
