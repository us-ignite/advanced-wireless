...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionCluster.is_approved'
        db.add_column(u'actionclusters_actioncluster', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionCluster.is_approved'
        db.delete_column(u'actionclusters_actioncluster', 'is_approved')
