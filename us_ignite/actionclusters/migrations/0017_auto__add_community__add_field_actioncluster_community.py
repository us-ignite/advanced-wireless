...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'actionclusters_community', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('community', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, unique=True, populate_from='community', overwrite=False)),
        ))
        db.send_create_signal(u'actionclusters', ['Community'])

        # Adding field 'ActionCluster.community'
        db.add_column(u'actionclusters_actioncluster', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actionclusters.Community'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Community'
        db.delete_table(u'actionclusters_community')

        # Deleting field 'ActionCluster.community'
        db.delete_column(u'actionclusters_actioncluster', 'community_id')
    ...
    models = {
        u'actionclusters.actioncluster': {
            ...
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['actionclusters.Community']", 'null': 'True', 'blank': 'True'}),
            ...
            'needs_partner': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['actionclusters.Year']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'actionclusters.community': {
            'Meta': {'object_name': 'Community'},
            'community': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'unique': 'True', 'populate_from': "'community'", 'overwrite': 'False'})
        },
        ...
        u'actionclusters.year': {
            'Meta': {'object_name': 'Year'},
            'default_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
