...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Year', fields ['default']
        db.delete_unique(u'actionclusters_year', ['default'])

        # Adding unique constraint on 'Year', fields ['year']
        db.create_unique(u'actionclusters_year', ['year'])


    def backwards(self, orm):
        # Removing unique constraint on 'Year', fields ['year']
        db.delete_unique(u'actionclusters_year', ['year'])

        # Adding unique constraint on 'Year', fields ['default']
        db.create_unique(u'actionclusters_year', ['default'])
