...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionCluster.year'
        db.alter_column(u'actionclusters_actioncluster', 'year_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actionclusters.Year'], null=True))

    def backwards(self, orm):

        # Changing field 'ActionCluster.year'
        db.alter_column(u'actionclusters_actioncluster', 'year_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actionclusters.Year']))
