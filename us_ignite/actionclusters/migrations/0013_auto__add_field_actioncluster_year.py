...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'actionclusters_actioncluster', 'year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['actionclusters.Year'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionCluster.year'
        db.delete_column(u'actionclusters_actioncluster', 'year_id')
    ...
    models = {
        u'actionclusters.actioncluster': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['actionclusters.Year']", 'blank': 'True'})
        },
