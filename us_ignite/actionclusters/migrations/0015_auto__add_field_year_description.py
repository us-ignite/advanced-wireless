...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Year.description'
        db.add_column(u'actionclusters_year', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Year.description'
        db.delete_column(u'actionclusters_year', 'description')
    ...
    models = {
        u'actionclusters.actioncluster': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['actionclusters.Year']"})
        },
