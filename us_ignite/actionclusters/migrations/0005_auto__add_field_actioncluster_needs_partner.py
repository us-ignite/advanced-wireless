...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionCluster.needs_partner'
        db.add_column(u'actionclusters_actioncluster', 'needs_partner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionCluster.needs_partner'
        db.delete_column(u'actionclusters_actioncluster', 'needs_partner')
