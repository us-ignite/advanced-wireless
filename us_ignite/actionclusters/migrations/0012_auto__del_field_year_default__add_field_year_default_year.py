...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Year.default'
        db.delete_column(u'actionclusters_year', 'default')

        # Adding field 'Year.default_year'
        db.add_column(u'actionclusters_year', 'default_year',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Year.default'
        db.add_column(u'actionclusters_year', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Year.default_year'
        db.delete_column(u'actionclusters_year', 'default_year')
