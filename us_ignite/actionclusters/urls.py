...
urlpatterns = patterns(
    ...
    url(r'^featured/$', 'actionclusters_featured', name='actionclusters_featured'),
    url(r'^featured/archive/(?P<slug>[-\w]+)/$', 'actionclusters_featured_archive',
    ...
    url(r'^(?P<slug>[-\w]+)/export/$', 'actioncluster_export', name='actioncluster_export'),
    ...
    url(r'^domain/(?P<domain>[-\w]+)/$', 'actioncluster_list', name='actioncluster_list_domain'),
    url(r'^stage/(?P<stage>[\d]{1})/$', 'actioncluster_list', name='actioncluster_list_stage'),
)
