...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pitch.order'
        db.add_column(u'smart_gigabit_communities_pitch', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pitch.order'
        db.delete_column(u'smart_gigabit_communities_pitch', 'order')
