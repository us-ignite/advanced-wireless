...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.is_homepage'
        db.add_column(u'apps_application', 'is_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.is_homepage'
        db.delete_column(u'apps_application', 'is_homepage')
