...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionClusterAward'
        db.create_table(u'awards_actionclusteraward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('award', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Award'])),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actionclusters.ActionCluster'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'awards', ['ActionClusterAward'])


    def backwards(self, orm):
        # Deleting model 'ActionClusterAward'
        db.delete_table(u'awards_actionclusteraward')
    ...
    models = {
        ...
        u'awards.actionclusteraward': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['actionclusters.ActionCluster']"}),
