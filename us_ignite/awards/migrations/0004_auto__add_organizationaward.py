...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationAward'
        db.create_table(u'awards_organizationaward', (
        ...
        db.send_create_signal(u'awards', ['OrganizationAward'])


    def backwards(self, orm):
        # Deleting model 'OrganizationAward'
        db.delete_table(u'awards_organizationaward')
    ...
    models = {
        ...
        u'awards.organizationaward': {
            'Meta': {'object_name': 'OrganizationAward'},
            'award': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['awards.Award']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
