...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActionClusterAward.application'
        db.delete_column(u'awards_actionclusteraward', 'application_id')

        # Adding field 'ActionClusterAward.actioncluster'
        db.add_column(u'awards_actionclusteraward', 'actioncluster',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ActionClusterAward.application'
        raise RuntimeError("Cannot reverse this migration. 'ActionClusterAward.application' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ActionClusterAward.application'
        db.add_column(u'awards_actionclusteraward', 'application',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actionclusters.ActionCluster']),
                      keep_default=False)

        # Deleting field 'ActionClusterAward.actioncluster'
        db.delete_column(u'awards_actionclusteraward', 'actioncluster_id')
    ...
    models = {
        ...
        u'awards.actionclusteraward': {
            'Meta': {'object_name': 'ActionClusterAward'},
            'actioncluster': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['actionclusters.ActionCluster']"}),
